...
fun main() {
    ...
    transaction {
        ...
        val units = listOf(
            ...
            Triple("ОТДЕЛ №1: УПРАВЛЕНИЕ КОСМИЧЕСКИМИ СИСТЕМАМИ", "ИТ-ДЕПАРТАМЕНТ ГАЛАКТИЧЕСКОЙ ИМПЕРИИ", "Дарт Вейдер (Энакин Скайуокер)"),
            Triple("Команда А: Флот и серверные комнаты", "ОТДЕЛ №1: УПРАВЛЕНИЕ КОСМИЧЕСКИМИ СИСТЕМАМИ", "Адмирал Пиетт"),
            Triple("Команда Б: Робототехника и дроиды", "ОТДЕЛ №1: УПРАВЛЕНИЕ КОСМИЧЕСКИМИ СИСТЕМАМИ", "C-3PO"),
            Triple("Команда В: Жизнеобеспечение и медслужба", "ОТДЕЛ №1: УПРАВЛЕНИЕ КОСМИЧЕСКИМИ СИСТЕМАМИ", "Доктор Корнелиус Эвазан"),
            Triple("ОТДЕЛ №2: РАЗРАБОТКА ПРОГРАММНОГО ОБЕСПЕЧЕНИЯ", "ИТ-ДЕПАРТАМЕНТ ГАЛАКТИЧЕСКОЙ ИМПЕРИИ", "Гранд Мофф Таркин"),
            Triple("Команда А: Death Star OS", "ОТДЕЛ №2: РАЗРАБОТКА ПРОГРАММНОГО ОБЕСПЕЧЕНИЯ", "Полковник Вульф Юларен"),
            Triple("Команда Б: Гиперпространство и навигация", "ОТДЕЛ №2: РАЗРАБОТКА ПРОГРАММНОГО ОБЕСПЕЧЕНИЯ", "Капитан Фазма"),
            Triple("Команда В: UI/UX и интерфейсы", "ОТДЕЛ №2: РАЗРАБОТКА ПРОГРАММНОГО ОБЕСПЕЧЕНИЯ", "Дженна Зан Арко"),
            Triple("ОТДЕЛ №3: КИБЕРБЕЗОПАСНОСТЬ И РАЗВЕДКА", "ИТ-ДЕПАРТАМЕНТ ГАЛАКТИЧЕСКОЙ ИМПЕРИИ", "Дарт Мол"),
            Triple("Команда А: Ситхи и темные джедаи", "ОТДЕЛ №3: КИБЕРБЕЗОПАСНОСТЬ И РАЗВЕДКА", "Дарт Тиранус (граф Дуку)"),
            Triple("Команда Б: Штурмовики (физическая безопасность)", "ОТДЕЛ №3: КИБЕРБЕЗОПАСНОСТЬ И РАЗВЕДКА", "Капитан Фазма"),
            Triple("Команда В: Разведка и контрразведка", "ОТДЕЛ №3: КИБЕРБЕЗОПАСНОСТЬ И РАЗВЕДКА", "Орсон Кренник"),
        )
